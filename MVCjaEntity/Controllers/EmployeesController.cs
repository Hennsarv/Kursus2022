...
namespace MVCjaEntity.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Photo(int id = 0)
        {
            ...
            byte[] pilt = employee.Photo??(new byte[1]);
        ...
        public ActionResult Edit(
            [Bind(Include = "EmployeeID,LastName,FirstName,Title,TitleOfCourtesy,BirthDate,HireDate,Address,City,Region,PostalCode,Country,HomePhone")] Employee employee,
            HttpPostedFileBase file // see on nüüd see muuutuja, mille kaudu me pildi saame    
            )
        {
            if (ModelState.IsValid)
            {
                ...
                emp.Property(x => x.Photo).IsModified = false;
